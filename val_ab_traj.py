...
from dataloader import FloorPlanDatasetTrajOnly
import time

TIME = time.strftime("%Y%m%d-%H%M%S")
CHECKPOINT = "results/20250909-090229_abl_traj/checkpoints/ckpt_epoch_150.pt"
...
def main():
    ...
    parser.add_argument('--test_floor_dir', default='Dataset_Scale100_SExPE/Selected_50_test/Target/')
    # parser.add_argument('--test_heat_dir',  default='Dataset_Scale100_SExPE/Selected_50_test/Condition_1/')
    parser.add_argument('--test_traj_dir',  default='Dataset_Scale100_SExPE/Selected_50_test/Condition_2/')

    parser.add_argument('--output_dir', default=f'./results_test/{TIME}_abl_traj_test/')
